...
public class VBajaEmpleado extends javax.swing.JFrame {

    private final JFrame principal;

    public VBajaEmpleado(JFrame ventana) {
        initComponents();
        principal = ventana;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("INTRODUZCA NOMBRE:");
    ...
    private void bajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bajaActionPerformed
        try {
            ...
            Logger.getLogger(VBajaEmpleado.class.getName()).log(Level.SEVERE, null, ex);
        }
